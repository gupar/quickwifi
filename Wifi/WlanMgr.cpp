...
VOID WINAPI CWlanManager::WlanNotificationCallback(PWLAN_NOTIFICATION_DATA pNotifData, PVOID pContext)
{
...
VOID CWlanManager::OnStationStateChange( const WLAN_HOSTED_NETWORK_PEER_STATE&)
{
    //
...
HRESULT CWlanManager::SetHostedNetworkName( CAtlString& strSsid)
{
    HRESULT hr = S_OK;
...
HRESULT CWlanManager::GetHostedNetworkName(CAtlString& strSsid)
{
    DWORD dwError = ERROR_SUCCESS;
...
HRESULT CWlanManager::SetHostedNetworkKey( CAtlString& strKey )
{
    HRESULT hr = S_OK;
    DWORD dwError = ERROR_SUCCESS;
...
HRESULT CWlanManager::GetHostedNetworkKey(CAtlString& strKey)
{
    HRESULT hr = S_OK;
    DWORD dwError = ERROR_SUCCESS;
...
HRESULT CWlanManager::StartHostedNetwork()
{
    HRESULT hr = S_OK;
    DWORD dwError = ERROR_SUCCESS;
...
HRESULT CWlanManager::StopHostedNetwork()
{
    HRESULT hr = S_OK;
...
HRESULT CWlanManager::GetStaionList( CRefObjList<CWlanStation*>& StationList
    )
{
    HRESULT hr = S_OK;
...
HRESULT CWlanManager::GetHostedNetworkInterfaceGuid(GUID& InterfaceGuid)
{
    HRESULT hr = S_OK;
    DWORD dwError = ERROR_SUCCESS;
    PWLAN_HOSTED_NETWORK_STATUS pAPStatus = NULL;                        // hosted network status
...
HRESULT CWlanManager::AdviseHostedNetworkNotification(CHostedNetworkNotificationSink * pSink)
{
    HRESULT hr = S_OK;
...
HRESULT CWlanManager::UnadviseHostedNetworkNotification()
{
    HRESULT hr = S_OK;
...
HRESULT CWlanManager::IsHostedNetworkStarted(bool & fStarted)
{
    HRESULT hr = S_OK;
